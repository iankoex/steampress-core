...
struct PostAdminController: RouteCollection {
    ...
    func createPostHandler(_ req: Request) async throws -> View {
        return try await req.adminPresenter.createPostView(errors: nil, title: nil, contents: nil, slugURL: nil, tags: [], isEditing: false, post: nil, isDraft: nil, titleError: false, contentsError: false, website: req.websiteInformation())
    }
    ...
    func editPostHandler(_ req: Request) async throws -> View {
        ...
        return try await req.adminPresenter.createPostView(errors: nil, title: post.title, contents: post.contents, slugURL: post.slugUrl, tags: tags.map { $0.name }, isEditing: true, post: post, isDraft: !post.published, titleError: false, contentsError: false, website: req.websiteInformation())
    }
