...
protocol BlogPresenter {
    ...
    func indexView(posts: [BlogPost], tags: [BlogTag], authors: [BlogUser.Public], tagsForPosts: [UUID: [BlogTag]], site: GlobalWebsiteInformation, paginationTagInfo: PaginationTagInformation) async throws -> View
    func postView(post: BlogPost, author: BlogUser.Public, tags: [BlogTag], site: GlobalWebsiteInformation) async throws -> View
    func allAuthorsView(authors: [BlogUser.Public], authorPostCounts: [UUID: Int], site: GlobalWebsiteInformation) async throws -> View
    func authorView(author: BlogUser.Public, posts: [BlogPost], postCount: Int, tagsForPosts: [UUID: [BlogTag]], site: GlobalWebsiteInformation, paginationTagInfo: PaginationTagInformation) async throws -> View
    ...
    func searchView(totalResults: Int, posts: [BlogPost], authors: [BlogUser.Public], searchTerm: String?, tagsForPosts: [UUID: [BlogTag]], site: GlobalWebsiteInformation, paginationTagInfo: PaginationTagInformation) async throws -> View
