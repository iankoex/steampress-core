...
public struct ViewBlogAdminPresenter: BlogAdminPresenter {
    ...
    public func createResetPasswordView(errors: [String]?, passwordError: Bool?, confirmPasswordError: Bool?, pageInformation: BlogAdminPageInformation) async throws -> View {
