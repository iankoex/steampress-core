...
class BlogPresenterTests: XCTestCase {
    ...
    func testBlogIndexPageGivenCorrectParameters() async throws {
        ...
        XCTAssertEqual(context.posts.first?.image, "https://user-images.githubusercontent.com/9938337/29742058-ed41dcc0-8a6f-11e7-9cfc-680501cdfb97.png")
        XCTAssertEqual(context.posts.first?.imageAlt, "SteamPress Logo")
