...
struct TestDataBuilder {
    ...
    static func anyUser(id: UUID? = nil, name: String = "Luke", username: String = "luke", password: String = "password", email: String = "like@skywalker.com", type: BlogUser.BlogUserType = .owner) -> BlogUser {
