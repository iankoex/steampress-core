...
//    
//    public init(context: DatabaseContext? = nil, eventLoopGroup: EventLoopGroup) {
//        self.context = context ?? .init(
//            configuration: DummyDatabaseConfiguration(middleware: [], eventLoopGroup: eventLoopGroup),
...
//        DummyDatabaseDriver(on: eventLoopGroup.next())
//    }
//}
//
...
//        DummyDatabase(context: context, eventLoopGroup: eventLoopGroup)
//    }
//    
